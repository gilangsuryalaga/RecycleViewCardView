...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names = {"I Took a Pill in Ibiza", "7 Years", "Pillow Talk", "Work From now", "Never Forget you", "Don't Let Me Down", "Love YourSelf", "Me,Myself & I", "Cake By The Ocean"
            , "Dangerous Woman", "My House", "Stressed Out", "One Dance", "Middle", "No"};
    String[] singers = {"Mike Posner", "Lukas Graham", "Zayn", "Fifth Harmony",
            "Zara Larsson&MNEK", "The Chainsmokers", "Justin Bieber", "G-Eazy x bebe Rexha", "DNCE", "Ariana Grande", "Flo",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("sdsds", String.valueOf(songList.get(2)));
